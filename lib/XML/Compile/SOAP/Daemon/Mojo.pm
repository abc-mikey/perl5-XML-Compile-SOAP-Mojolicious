...
use Log::Report qw/xml-compile-soap-daemon/; # TODO does this actually work with MojoX::Log::Report?
...
{   my ($self, $args) = @_;
    ...
    # use a Mojo::Log compatible with Log::Report
    $daemon->app->{log} = MojoX::Log::Report->new;
